<html>
<head>
<h1> Stardust Crusaders Incorporated Employee Management System </h1>
</head>
<body>
...
$conn = new mysqli('localhost', 'phpuser', 'password', 'employees' );
...
?>
<p>For more information on connecting PHP to MySQL click <a href="https://www.php.net/manual/en/book.mysqli.php">here. </a></p>
</body>
</html>
